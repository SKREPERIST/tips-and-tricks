...
function f5() {
  let out4 = document.querySelector(".out-4"),
    ...
    checkClass = out4.getAttribute("class");

  if (checkClass == "out-4 bg-4") out5.innerHTML = true;
...
function f6() {
  let out = document.querySelector(".out-6"),
    ps = document.querySelectorAll(".p-6");

  out.innerHTML = ps.length;
}
...
function f7() {
  let blocks = document.querySelectorAll(".out-7");
  console.log(blocks);
  for (i = 0; i < blocks.length; i++) {
    blocks[i].classList.add("bg-7");
  }
}
...
function f8() {
  let blocks = document.querySelectorAll(".out-8");

  for (i = 0; i < blocks.length; i++) {
    blocks[i].classList.toggle("bg-8");
  }
}
...
let blocks10 = document.querySelectorAll(".out-10");

function f10() {
  this.classList.toggle("bg-10");
}

for (i = 0; i < blocks10.length; i++) {
  blocks10[i].onclick = f10;
}
...
function f18() {
  let out = document.querySelector(".out-18"),
    p = document.querySelector(".p-18").getAttribute("data-b");
...
function f19() {
  let out = document.querySelector(".out-19"),
    p = document.querySelectorAll(".p-19"),
    x = "";

  for (i = 0; i < p.length; i++) {
    x += p[i].getAttribute("data-b") + " ";
  }
  out.innerHTML = x;
}
