...
function f7() {
  let inp = document.querySelector(".i-7").value,
    out1 = document.querySelector(".out-71"),
    out2 = document.querySelector(".out-72");
...
function f8() {
  ...
  out1.innerHTML =
    ...
    "<button type='button' class='b-81'>PUSH</button>";
...
function f81() {
  let out2 = document.querySelector(".out-81"),
    inp = document.querySelector(".i-81").value;
...
function f10() {
  ...
  out.style.backgroundColor = inp.value;
}
...
function f18() {
  let s = document.querySelector(".s-18");
...
function f19() {
  let i_text = document.querySelector(".i-191").value;
  let i_pass = document.querySelector(".i-192").value;
  let out = document.querySelector(".out-19");

  out.innerHTML = i_text + " " + i_pass;
}
...
function f20(e) {
  ...
  let form = document.querySelector(".f-20"),
    text = form.elements["username"].value,
    pass = form.elements["password"].value,
    out = document.querySelector(".out-20");

  console.log(form.elements); // так можно обратиться к элементу внутри формы
